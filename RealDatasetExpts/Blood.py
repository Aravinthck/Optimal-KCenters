...
cols.extend('y')
df = pd.read_csv(os.path.join(DATA_DIR, 'transfusion.data'), sep = ',') 
...
with open(os.path.join(RESULT_DIR, 'blood.pkl'), 'wb') as outp:
...
with open(os.path.join(DATAINFO_DIR, 'blood.pkl'), 'wb') as outp:
