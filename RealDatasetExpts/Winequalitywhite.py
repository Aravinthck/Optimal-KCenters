...
mmOpt.set_model(MinMax(initConstrCnt=9, optimalGap=0.05, tol=1, time= 15,  initConstrIntRatio=3))
...
with open(os.path.join(RESULT_DIR, 'winequality.pkl'), 'wb') as outp:
...
with open(os.path.join(DATAINFO_DIR, 'winequality.pkl'), 'wb') as outp:
